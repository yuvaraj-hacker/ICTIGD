                        ...
                        <section className=" flex flex-col gap-10 ">
                            ...
                            <div className='w-fit mx-auto'>
                                <Link to="/paper-submission">
                                    <div className=" bg-white    rounded-full  py-3 w-fit text-[#014BBD] px-6 mx-auto cursor-pointer font-semibold shadow-md hover:scale-95  group duration-300 md:text-base text-sm">
